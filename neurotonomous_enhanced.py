...
class QNetwork(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(NUM_SENSORS, 24)
        self.fc2 = nn.Linear(24, 24)
        self.fc3 = nn.Linear(24, len(ACTIONS))
        ...
        for offset in SENSOR_ANGLES: 
            ...
            for d in range(1, SENSOR_LENGTH + 1, 5):
                ...
                if 0 <= sx < WIDTH and 0 <= sy < HEIGHT: 
                    ...
                    # Check for obstacle color (white in original, light gray in enhanced)
...
def train(model, optimizer, replay_buffer, batch_size=32, gamma=0.95):
...
def main():
    ...
    while episode < max_episodes:
        ...
        while not done:
            ...
            reward = -100 if crashed else 1 - np.mean(state)
            total_reward += reward
